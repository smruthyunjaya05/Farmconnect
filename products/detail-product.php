...
if (!isset($_SESSION['user_id'])) {
    $_SESSION['user_id'] = 0; // Set a default value if user_id is not set
}
//till here
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6"><span class="pt-1 d-inline-block">Pack </span></div>
                        </div>
                        <div class="row">
                            <div class="col-sm-5">
                        ...
                        <?php if($validate->rowCount() > 0) : ?>
                            <button name="submit" type="submit" class="btn-insert mt-3 btn btn-primary btn-lg" disabled>
                                <i class="fa fa-shopping-basket"></i> Added to the Cart
                            </button>
                        <?php else : ?>
                        ...
                        <?php else: ?>
                            <div class="mt-5 alert alert-success bg-success text-white text-center">
                                login to buy this product or add it to cart
                            </div>
                        <?php endif; ?>
                        </form>
                    </div>
            ...
            $(".btn-insert").on("click", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(){
                        ...
                        $(".btn-insert").html("<i class='fa fa-shopping-basket'></i> Added to the Cart").prop("disabled", true);
                        withRef();
